...
function checkTableName($shortTName )
{
	...
	if ("locations" == $shortTName )
		return true;
	if ("reservations" == $shortTName )
		return true;
	if ("treatments" == $shortTName )
		return true;
	if ("statuses" == $shortTName )
		return true;
	if ("servicehours" == $shortTName )
		return true;
	if ("v_available_reservations" == $shortTName )
		return true;
	if ("figura_users" == $shortTName )
		return true;
	...
	if ("admin_users" == $shortTName )
		return true;
	if ("reservationsreception" == $shortTName )
		return true;
	if ("statushistory" == $shortTName )
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("locations");
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("treatments");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("statuses");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("servicehours");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("v_available_reservations");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="v_available_reservations";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("figura_users");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("reservationsReception");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="reservationsReception";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("statushistory");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
...
//	default permissions
	...
	if( $table=="v_available_reservations" )
	{
		if( $sUserGroup=="reception" )
		{
						return "AEDSPI".$extraPerm;
...
//	default permissions
	...
	if( $table=="reservationsReception" )
	{
		if( $sUserGroup=="reception" )
		{
						return "ADESPI".$extraPerm;
