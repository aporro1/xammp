...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("locations" == $this->chrt_array['tables'][0])
			return true;
		if("reservations" == $this->chrt_array['tables'][0])
			return true;
		if("treatments" == $this->chrt_array['tables'][0])
			return true;
		if("statuses" == $this->chrt_array['tables'][0])
			return true;
		if("servicehours" == $this->chrt_array['tables'][0])
			return true;
		if("v_available_reservations" == $this->chrt_array['tables'][0])
			return true;
		if("figura_users" == $this->chrt_array['tables'][0])
			return true;
		if("figuraugrights" == $this->chrt_array['tables'][0])
			return true;
		if("figuraugmembers" == $this->chrt_array['tables'][0])
			return true;
		if("figura_users" == $this->chrt_array['tables'][0])
			return true;
		if("reservations" == $this->chrt_array['tables'][0])
			return true;
		if("statushistory" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
