...
class ProjectSettings
{
	...
	*/
	...
	function getConnId()
	{
		...
		if( $connId == "" ) {
			return "figura_at_10_101_125_22";
		}
		return $connId;
	}
	...
	*/
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("figura_users", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "locations" ] = array( "url" => "locations", "type" => 0 );
	$projectEntitiesReverse[ "locations" ] = "locations";
	$projectEntities[ "reservations" ] = array( "url" => "reservations", "type" => 0 );
	$projectEntitiesReverse[ "reservations" ] = "reservations";
	$projectEntities[ "treatments" ] = array( "url" => "treatments", "type" => 0 );
	$projectEntitiesReverse[ "treatments" ] = "treatments";
	$projectEntities[ "statuses" ] = array( "url" => "statuses", "type" => 0 );
	$projectEntitiesReverse[ "statuses" ] = "statuses";
	$projectEntities[ "servicehours" ] = array( "url" => "servicehours", "type" => 0 );
	$projectEntitiesReverse[ "servicehours" ] = "servicehours";
	$projectEntities[ "v_available_reservations" ] = array( "url" => "v_available_reservations", "type" => 0 );
	$projectEntitiesReverse[ "v_available_reservations" ] = "v_available_reservations";
	$projectEntities[ "figura_users" ] = array( "url" => "figura_users", "type" => 0 );
	$projectEntitiesReverse[ "figura_users" ] = "figura_users";
	...
	$projectEntities[ "reservationsReception" ] = array( "url" => "reservationsreception", "type" => 1 );
	$projectEntitiesReverse[ "reservationsreception" ] = "reservationsReception";
	$projectEntities[ "statushistory" ] = array( "url" => "statushistory", "type" => 0 );
	$projectEntitiesReverse[ "statushistory" ] = "statushistory";
}
