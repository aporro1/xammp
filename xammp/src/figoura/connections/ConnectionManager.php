...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "figura_at_10_101_125_22";
		$data["connName"] = "Figura at 62.169.23.6";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;62.169.23.6;root;secure_root_password;;Figura;;1"; //currently unused

		$this->_connectionsIdByName["Figura at 62.169.23.6"] = "figura_at_10_101_125_22";

		$data["connInfo"] = array();
		$data["ODBCUID"] = "root";
		$data["ODBCPWD"] = "secure_root_password";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][0] = "62.169.23.6";
		$data["connInfo"][1] = "root";
		$data["connInfo"][2] = "secure_root_password";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "Figura";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=62.169.23.6;Uid=root;Pwd=secure_root_password;Database=Figura;OPTION=3";
		// encription set
		...
		$connectionsData["figura_at_10_101_125_22"] = $data;
