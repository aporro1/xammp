...
$nonAdminTablesArr[] = "locations";
$nonAdminTablesArr[] = "reservations";
$nonAdminTablesArr[] = "treatments";
$nonAdminTablesArr[] = "statuses";
$nonAdminTablesArr[] = "servicehours";
$nonAdminTablesArr[] = "v_available_reservations";
$nonAdminTablesArr[] = "figura_users";
$nonAdminTablesArr[] = "reservationsReception";
$nonAdminTablesArr[] = "statushistory";
...
$wGroupTableName = $ug_connection->addTableWrappers( "figurauggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "figuraugrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "figuraugrights" );
