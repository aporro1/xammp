...
$pageMask[$table] = $mask;
$tables[$table] = array("locations", " " . "Locations");
$table = "reservations";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("reservations", " " . "Reservations");
$table = "treatments";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("treatments", " " . "Θεραπείες");
$table = "statuses";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("statuses", " " . "Statuses");
$table = "servicehours";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("servicehours", " " . "Servicehours");
$table = "v_available_reservations";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
if( pageEnabled($table, 'edit') || pageEnabled($table, 'inline_edit') )
...
$pageMask[$table] = $mask;
$tables[$table] = array("v_available_reservations", " " . "V Available Reservations");
$table = "figura_users";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("figura_users", " " . "Figura Users");
...
$pageMask[$table] = $mask;
$tables[$table] = array("reservationsreception", " " . "Reservations Reception");
$table = "statushistory";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("statushistory", " " . "Statushistory");
